---
title: "Multilevel Models in Social Epidemiology"
...
<br>
<br>
![](images/mlm-structure.png)
:::

::: {.column width="60%"}
"Multilevel" models:
![](images/mlm-types.png)
:::
:::

::: aside
Image credits: @subramanian2003b and  https://bookdown.org/steve_midway/DAR/random-effects.html
:::
...
::: columns
::: {.column width="50%"}
![](images/syme-1994-title.png){fig-align="center" width="70%"}
:::
...
::: columns
::: {.column width="50%"}
![](images/mckinlay-epiphenomena.png){fig-align="center" width="100%"}
:::

::: {.column width="50%"}
![](images/mckinlay-1999-quote.png){fig-align="center"}
:::
:::
...
::: {.column width="45%"}
![John Snow's 'Grand Experiment'. See Snow (1855) reprinted [-@snow1936]](images/snow-map.png)
:::
:::
...
::: columns
::: {.column width="45%"}
Fixed effects: [No.]{.red} ![](images/mellor-hsr-2003.png){width="80%"}
:::
...
::: {.column width="45%"}
Random effects: [Yes!]{.blue} ![](images/subu-hsr-2003.png){width="70%"}
:::
:::
...
::: columns
::: {.column width="40%"}
### [Zombie hypothesis...]{.blue}
![](images/not-dead.png)
:::

::: {.column width="60%"}
![](images/dunn-jech.png)
:::
:::
...
![](images/jokela-2014-title.png){fig-align="center" width="70%"}
...
::: columns
::: {.column width="55%"}
![](images/massey-2008-ajs.png){width=100%}
:::
...
::: {.column width="65%"}
![](images/chetty-2016-fig.png){fig-align="center"}
:::
:::
...
::: columns
::: {.column width="60%"}
![](images/hamad-2020-title.png){fig-align="center" width="100%"}
:::

::: {.column width="40%"}
<br>

> ...incoming refugees [were assigned]{.blue} to neighborhoods with varying levels of disadvantage throughout the country 
...
::: columns
::: {.column width="55%"}
![](images/hamad-2020-results.png){fig-align="center" width="100%"}
:::
...
::: aside
@persmark2020 on the probability of reporting opioid use disorder.
:::
