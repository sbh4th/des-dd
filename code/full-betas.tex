...
\begin{tikzpicture}[scale=2]
  ...
  \draw [<->,thick] (0,3) node (yaxis) [above] {$y$} |- (4.5,0) node (xaxis) [right] {$time (X)$};
    ...
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (0.6,1.2) -- (0.6,0.35) node     [black,midway,xshift=0.5cm]  {$\beta_{1}$};
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (0.8,1.65) -- (0.8,1.3) node     [black,midway,xshift=0.8cm]  {$\beta_{4}+\beta_{5}$};
	\draw [decorate,decoration={brace, amplitude=5pt},xshift=3pt,yshift=0pt] (3.5,0.7) -- (3.5,0.3) node 		[black,midway,xshift=0.5cm]  {$\beta_{2}$};
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=3pt,yshift=0pt] (3.5,1.3) -- (3.5,0.7) node     [black,midway,xshift=0.8cm]  {$\beta_{2}+\beta_{6}$};
	\draw [decorate,decoration={brace, amplitude=5pt},xshift=2pt,yshift=0pt] (3.5,2.0) -- (3.5,1.6) node 		[black,midway,xshift=0.5cm]  {$\beta_{3}$};
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=2pt,yshift=0pt] (3.5,2.6) -- (3.5,2.4) node     [black,midway,xshift=0.8cm]  {$\beta_{3}+\beta_{7}$};
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (1.1,0.65) -- (1.1,0.4) node     [black,midway,xshift=0.5cm]  {$\beta_{4}$};;
