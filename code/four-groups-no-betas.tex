...
\begin{tikzpicture}[scale=2]
  ...
  \draw [<->,thick] (0,3) node (yaxis) [above] {$y$} |- (4.5,0) node (xaxis) [right] {$time (X)$};
    ...
    \fill[red!60] (TH) circle (1.0pt) node[right, color=black] {Treated (High)};
    ...
    \fill[blue!30] (c0_0) circle (1pt);
    \fill[blue!30] (c0_1) circle (1pt);
    % control-high
    \draw[thick, color=blue!60] (0.5,0.7) coordinate (c0_0) -- (3.5,1.5) coordinate (c0_1);
    \fill[blue!60] (c0_0) circle (1pt);
    \fill[blue!60] (c0_1) circle (1pt);
    ...
    \fill[red!30] (t0_0) circle (1pt);
    \fill[red!30] (t1_1) circle (1pt);
    % counterfactual-low
    ...
    \fill[red!60] (t0_0) circle (1pt);
    \fill[red!60] (t1_1) circle (1pt);
    % counterfactual-high
	...
	%\draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (1.0,1.3) -- (1.0,0.5) node 		[black,midway,xshift=0.5cm]  {$\beta_{1}$};
    %\draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (1.2,1.8) -- (1.2,1.0) node     [black,midway,xshift=0.5cm]  {$\beta_{1}$};
