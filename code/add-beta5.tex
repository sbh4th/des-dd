...
\begin{tikzpicture}[scale=2]
  ...
  \draw [<->,thick] (0,3) node (yaxis) [above] {$y$} |- (4.5,0) node (xaxis) [right] {$time (X)$};
    ...
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (0.8,1.65) -- (0.8,1.35) node     [black,midway,xshift=0.8cm]  {$\beta_{4}+\beta_{5}$};
    ...
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=1pt,yshift=0pt] (1.1,0.65) -- (1.1,0.5) node     [black,midway,xshift=0.5cm]  {$\beta_{4}$};
