...
\begin{tikzpicture}[scale=2]
  ...
  \draw [<->,thick] (0,3) node (yaxis) [above] {$y$} |- (4.5,0) node (xaxis) [right] {$time (X)$};
	...
	\draw [decorate,decoration={brace, amplitude=5pt},xshift=2pt,yshift=0pt] (3.5,1.9) -- (3.5,1.6) node 		[black,midway,xshift=0.5cm]  {$\beta_{3}$};
    \draw [decorate,decoration={brace, amplitude=5pt},xshift=2pt,yshift=0pt] (3.5,2.6) -- (3.5,2.3) node     [black,midway,xshift=0.5cm]  {$\beta_{3}$};
